    ...
    <div className="min-h-screen py-20 px-4 md:px-20">
      <div className="max-w-4xl mx-auto shadow-md rounded-lg p-8 [&>section>h2]:text-gray-200 [&>section>p]:text-gray-400">
        ...
        <section className="mb-8">
          ...
          <p>
            Ofrecemos servicios de diseño y desarrollo de páginas web adaptados
            a las necesidades de nuestros clientes. Esto incluye, pero no se
            limita a, diseño gráfico, optimización para motores de búsqueda
            (SEO) y soporte técnico (mantenimiento) durante el período acordado.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            imágenes, logotipos y cualquier otro material relevante. El cliente
            debe asegurarse de que posee los derechos necesarios para utilizar
            dicho contenido.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            cliente deberá abonar un adelanto (generalmente 1/3 o 1/2 del total)
            antes de iniciar el proyecto. El saldo restante será pagado una vez
            finalizado el proyecto y antes de la entrega final.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            incorrecta proporcionada por el cliente ni de problemas técnicos que
            surjan de proveedores externos, como servidores de hosting o
            dominios.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            de su página web estará sujeta a cargos adicionales. Los reembolsos
            no serán emitidos una vez que el proyecto haya sido aprobado y
        ...
        <section>
          ...
          <p>
            ...
            comprendido y aceptado estos Términos y Condiciones. Nos reservamos
            el derecho de modificar estos términos en cualquier momento,
            mostrando la fecha de ultima edición en la parte inferior de esta
            página.
          </p>
        </section>
