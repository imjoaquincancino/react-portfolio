export default function AboutMe() {
  return (
    <>
      ...
      <section className="bg-gray-950 text-white mx-auto container lg:max-w-4xl md:max-w-2xl">
        <div className="flex justify-center items-center py-16 md:py-36 h-screen w-auto">
          <div className=" text-center h-full flex flex-col items-center justify-center px-8 max-w-xl">
            ...
            <nav className="flex flex-wrap gap-4 mt-8">
              <a
                className="rounded-full bg-gray-800 px-4 py-1 border border-gray-600 inline-flex items-center justify-center gap-2"
                href=""
              >
