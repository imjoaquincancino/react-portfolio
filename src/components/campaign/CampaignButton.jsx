...
export default function CTAcampaign({ text, icon }) {
  return (
    <span className="relative inline-flex overflow-hidden rounded-full p-[1px]">
      ...
      <a
        href="#planes"
        className="font-mono font-bold inline-flex gap-1 items-center justify-center text-xs sm:text-sm w-fit bg-gradient-to-br from-brand/20 to-brand/10 mx-auto py-2 px-3 md:px-6  rounded-full cursor-pointer bg-gray-800 text-white/80 backdrop-blur-3xl whitespace-nowrap"
      >
