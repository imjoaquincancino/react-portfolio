...
export default function CTAcampaign({ text, url, yellow }) {
  return (
    <span className="relative inline-flex overflow-hidden rounded-full p-[1px]">
      ...
      <a
        href={url}
        className={`font-mono font-bold inline-flex gap-1 items-center justify-center text-xs sm:text-sm md:text-base w-fit bg-gradient-to-tr from-brand/20 to-brandlight/20 mx-auto py-2 px-3 md:px-6  rounded-full cursor-pointer bg-gray-800 ${yellow ? "text-green-400/90" : "text-white/80"}  backdrop-blur-3xl whitespace-nowrap`}
      >
