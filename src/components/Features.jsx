      ...
      <div>
        <div className={`size-fit rounded-full p-0.5 lg:p-[3px] bg-gradient-to-l ${borderColor}`}>
          <div className="size-12 lg:size-14 flex flex-col items-center justify-center overflow-visible text-center bg-black text-white rounded-full">
            <div className={`size-full flex flex-col items-center justify-center overflow-visible text-center bg-gradient-to-br ${gradientColor} rounded-full`}>
...
export function Features() {
  return (
    <section id="beneficios" className="mt-20 sm:mt-32 xs:p-6 mx-auto w-full max-w-screen-xl space-y-8 p-4 sm:p-12">
      ...
      <div className="space-y-1 z-10">
        ...
        Para atraer más clientes, <strong>vender más</strong> y llevar tu negocio al siguiente nivel.
        </h2>
      </div>
