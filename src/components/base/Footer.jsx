      ...
      <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-8">
        ...
        <div className="flex items-center justify-center">
              <span className="text-xs text-gray-600 py-1">
                Ruta 225, Puerto Varas, Ensenada © {(new Date).getFullYear()} <a className="text-gray-500" href="https://joaquincancino.dev">Joaquín Cancino</a>. Ensenada, Puerto Varas. Todos los derechos reservados.
              </span>
        </div>
      </div>
    </footer>
