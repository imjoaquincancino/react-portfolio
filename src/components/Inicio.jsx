...
export function Inicio() {
  return (
    <section className="flex h-screen items-center justify-center px-4">
      <div className="animate__animated animate__fadeIn animate__delay-0.5s bg-gradient-to-l from-[#4840de60] to-[#8233a960] w-3/4 max-w-xl absolute rotate-[-7deg] z-0 blur-[160px] rounded-full h-96 md:h-80"></div>
